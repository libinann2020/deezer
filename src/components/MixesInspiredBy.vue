        ...
        <RouterLink :to="to"  class="relative">
            <div class="flex items-center bg-[#23232D] rounded-sm h-[54px] relative">
                <div class="flex items-center w-[54px]" @mouseenter="isHover = true" @mouseleave="isHover = false">
                    ...
                    <div :class="isHover ? 'transition ease-in duration-100 bg-opacity-100' : 'transition ease-out duration-100 bg-opacity-0'" class="absolute z-20 p-1.5 rounded-full bg-white left-[6px]">
                        <Play :size="30"/>
                    </div>
