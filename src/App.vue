...
<template>
  <div id="TopNav" class="fixed right-0 flex items-center justify-between w-[calc(100%-240px)] h-[56px] border-b border-b-[#32323D]">
    <div class="flex items-center w-full">
      ...
      <input type="text" class="p-1 bg-transparent outline-none font-[300] placeholder-[#BEBEC7] text-[#FFFFFF] w-full max-w-xl" placeholder="Search">
    </div>
    <div class="flex items-center pr-10">
      <div class="mr-4 p-1 hover:bg-gray-600 rounded-full cursor-pointer">
        <Bell fillColor="#FFFFFF" :size="20"/>
      </div>
      <img class="rounded-full w-[33px]" src="https://yt3.ggpht.com/yti/AOXPAcXHPqGMyyT6MY-UlNXwd8Z509vJzAFlfpyLLA=s88-c-k-c0x00ffffff-no-rj-mo">
    </div>
  </div>
  <div id="SideNav" class="fixed w-[240px] bg-[#191922] h-[100vh] border-r-[#32323D]">
    ...
    <SideMenuItem iconString="podcast" :iconSize="20" pageUrl="/podcasts" name="Podcast"/>
